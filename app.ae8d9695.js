...
(0, _jquery.default)("#buttonCopy1").on("click", function () {
  var amount = (0, _jquery.default)("#sendAmount").val();
  (0, _copyToClipboard.default)(String(amount));
  (0, _jquery.default)("#messageCopy").fadeIn(function () {
    setTimeout(function () {
      (0, _jquery.default)("#messageCopy").fadeOut();
    }, 500);
  });
});
(0, _jquery.default)("#buttonCopy2").on("click", function () {
  var address = (0, _jquery.default)("#sendAddress").val();
